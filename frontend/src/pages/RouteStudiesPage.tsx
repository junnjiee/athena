...
export function RouteStudiesPage() {
   ...
   *  so it lands as a plain point. Area objectives route to the first live road
   *  point in their footprint; a bridge should not acquire ground it does not have. */
            ...
            <div className="min-h-0 flex-1">
              ...
              {branch === 's3' && s3Panel === 'block' && (
                <BlockForcePanel
                  ...
                  onSetBlockEstablishment={(inletId, establishedMinutes) => {
                    void planBlocks(
                      undefined,
                      undefined,
                      replaceBlockEstablishment(
