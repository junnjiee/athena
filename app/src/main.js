...
import sgWeatherLayer from './data/sg/sgWeather.js';
import sgMobilityLayer from './data/sg/sgMobility.js';
import sgHazardLayer from './data/sg/sgHazard.js';
...
async function init() {
  ...
  try {
    ...
    // ATHENA — Singapore data plane, served through the Athena proxy at /api/sg.
    dataManager.register(sgWeatherLayer);
    dataManager.register(sgMobilityLayer);
    dataManager.register(sgHazardLayer);
