...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  // ATHENA — Singapore data plane. Tokens are single [a-z0-9] characters and
  // the namespace holds 36; these three take h/y/z from the 20 that were free.
  Object.freeze({ id: 'sg-weather', token: 'h', disposition: 'enabled-only' }),
  Object.freeze({ id: 'sg-mobility', token: 'y', disposition: 'enabled-only' }),
  Object.freeze({ id: 'sg-hazard', token: 'z', disposition: 'enabled-only' }),
